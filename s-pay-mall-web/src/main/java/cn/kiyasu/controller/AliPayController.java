...
import cn.kiyasu.controller.dto.CreatePayRequestDTO;
...
public class AliPayController {
    ...
    public Response<String> createPayOrder(@RequestBody CreatePayRequestDTO createPayRequestDTO) {
        try {
            ...
            log.info("商品下单，根据商品ID创建支付单失败 userId:{} productId:{}", createPayRequestDTO.getUserId(), createPayRequestDTO.getProductId());
            return Response.<String>builder()
