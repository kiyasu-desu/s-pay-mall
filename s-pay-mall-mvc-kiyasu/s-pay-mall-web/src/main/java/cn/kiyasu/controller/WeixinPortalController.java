...
import cn.kiyasu.common.weixin.MessageTextEntity;
import cn.kiyasu.common.weixin.SignatureUtil;
import cn.kiyasu.common.weixin.XmlUtil;
...
/**
 * 微信服务对接，对接地址：<a href="http://kiyasu.nat100.top/api/v1/weixin/portal/receive">/api/v1/weixin/portal/receive</a>
 * <p>
 * http://kiyasu.nat100.top/api/v1/weixin/portal/receive/
 */
@Slf4j
@RestController()
@CrossOrigin("*")
