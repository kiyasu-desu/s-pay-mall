...
- 域名 自行申请和配置。[https://console.bce.baidu.com/dns/#/dns/domain/list?zoneName=kiyasu.tech](https://console.bce.baidu.com/dns/#/dns/domain/list?zoneName=kiyasu.tech)
...
```java
git clone https://github.com/kiyasu-desu/s-pay-mall.git
